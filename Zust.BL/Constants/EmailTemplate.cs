...
public static class EmailTemplate
{
    ...
    public static string NewPasswordTemplate => """
            ...
            <div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
              ...
              <h2 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-weight: 500;font-size: 20px;color: #4F545C;letter-spacing: 0.27px;">Hey __$userName,</h2>
                <p>We’ve received a request to set new password for your account with __$appName.</p>
                <p>If you didn’t request a new password, no further action is required. Your account is safe!</p>
    ...
    public static string ForgotPasswordTemplate => """
            ...
            <div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
              ...
              <h2 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-weight: 500;font-size: 20px;color: #4F545C;letter-spacing: 0.27px;">Hey __$userName,</h2>
                <p>We’ve received a request to reset the password for your account with __$appName.</p>
                <p>If you didn’t request a password reset, no further action is required. Your account is safe!</p>
