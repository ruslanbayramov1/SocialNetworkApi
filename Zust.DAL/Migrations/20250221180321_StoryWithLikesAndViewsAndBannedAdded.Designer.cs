...
namespace Zust.DAL.Migrations
{
    ...
    [Migration("20250221180321_StoryWithLikesAndViewsAndBannedAdded")]
    partial class StoryWithLikesAndViewsAndBannedAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zust.Core.Entities.Story", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zust.Core.Entities.StoryLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zust.Core.Entities.StoryView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zust.Core.Entities.Follow", b =>
                {
                    b.HasOne("Zust.Core.Entities.User", "FollowerUser")
                        .WithMany("Followings")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Zust.Core.Entities.User", "FollowingUser")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("Zust.Core.Entities.Story", b =>
                {
                    b.HasOne("Zust.Core.Entities.User", "StoryOwner")
                        .WithMany("Stories")
            ...
            modelBuilder.Entity("Zust.Core.Entities.StoryLike", b =>
                {
                    ...
                    b.HasOne("Zust.Core.Entities.Story", "Story")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("Zust.Core.Entities.StoryView", b =>
                {
                    ...
                    b.HasOne("Zust.Core.Entities.User", "ViewerUser")
                        .WithMany("StoryViews")
